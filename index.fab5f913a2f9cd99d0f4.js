...
var ToggleMode = function ToggleMode() {
  var windowMedia = window.matchMedia;
  var windowMatches = windowMedia('(prefers-color-scheme: dark)').matches;
  var links = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.find)('.main__lang-link');
  var vectors = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.find)('.dark-mode-svg');
  var buttons = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.find)('button');
  var body = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.findOne)('body');
  var input = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.findOne)('input');
  var image = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.findOne)('.main__image');
  var button = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.findOne)('.header__link-btn');
  var tooltip = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.findOne)('.main__audio-tooltip');
  var form = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.findOne)('.main__form-top');
  var lbreak = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.findOne)('.footer__line-break');
  var footer = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.findOne)('footer');

  if (windowMedia && windowMatches) {
    document.documentElement.style.setProperty('--white-color-x0', '#202124');
    document.documentElement.style.setProperty('--black-color-x0', '--white-color-x0');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(body, 'color: #bdc1c6');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(image, 'filter: brightness(0) invert(1)');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(footer, 'background: #171717');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(button, 'background: #8AB4F8; color: #202124');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(input, 'background: transparent; color: #FFF');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(form, 'border: 1px solid #5f6368');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(buttons, 'background: #303134; color: #e8eaed');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(vectors, 'fill: #bdc1c6');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(links, 'color: #8ab4f8');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(lbreak, 'border: 1px solid #212327');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(tooltip, 'background: #353535; color: #FFF; border: 1px solid #FFF;');
  } else {
    (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.style)(button, 'color: #FFFFFF');
  }
};
...
var findOne = function findOne(element) {
  return document.querySelector(element);
};
var find = function find(element) {
  return document.querySelectorAll(element);
};
var style = function style(elements, styles) {
  if (!elements) {
...
/* harmony import */ var _utils_ToggleMode__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/ToggleMode */ "./src/utils/ToggleMode.js");
/* harmony import */ var _utils_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/helpers */ "./src/utils/helpers.js");




var input = (0,_utils_helpers__WEBPACK_IMPORTED_MODULE_3__.findOne)('input');
(0,_utils_helpers__WEBPACK_IMPORTED_MODULE_3__.autoFocus)(input);
(0,_utils_ToggleMode__WEBPACK_IMPORTED_MODULE_2__["default"])();
})();
